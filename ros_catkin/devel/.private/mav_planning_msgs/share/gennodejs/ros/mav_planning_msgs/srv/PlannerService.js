...
class PlannerServiceResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('polynomial_plan')) {
        ...
        this.polynomial_plan = new PolynomialTrajectory4D();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PolynomialTrajectory4D.serialize(obj.polynomial_plan, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.polynomial_plan = PolynomialTrajectory4D.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += PolynomialTrajectory4D.getMessageSize(object.polynomial_plan);
  ...
  static Resolve(msg) {
    ...
    if (msg.polynomial_plan !== undefined) {
      resolved.polynomial_plan = PolynomialTrajectory4D.Resolve(msg.polynomial_plan)
    }
    else {
      resolved.polynomial_plan = new PolynomialTrajectory4D()
    }
...
module.exports = {
  ...
  md5sum() { return '2300e9625a407fe336df3e99be5434be'; },
